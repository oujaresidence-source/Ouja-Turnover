...
class MonthlyPublicBotBoundaryTests(unittest.TestCase):
    ...
    def test_every_v2_handler_refuses_calls_when_either_switch_is_off(self):
        handlers = (
            ...
            self.bot._api_monthly_preview_search,
            ...
            self.bot._handle_monthly_preview_home,
            self.bot._handle_monthly_preview_browse,
            self.bot._handle_monthly_preview_match,
            self.bot._handle_monthly_preview_listing,
